...
export default function LoginForm() {
  ...
  return (
    <form
      ...
      className="flex flex-col justify-evenly w-[30vw] shadow-2xl px-10 py-5 rounded-lg rounded-t-none bg-white relative"
    >
      <p className="text-3xl text-center font-semibold text-blue-500">Login</p>
